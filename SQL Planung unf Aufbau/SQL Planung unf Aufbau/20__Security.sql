...
--Datenbankrollen
--vordefinierte Rollen gelten für alle

--Schema
--Tabellen, Prozeduren, F() können in "Ordnern" = Schemas abgelegt werden
--Rechtevergaben: Benutzer in Rollen -->Rolle Rechte auf Schema
--wie unter Windows: Gruppe bekommt Rechte auf Ordner 
